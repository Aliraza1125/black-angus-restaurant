...
const Header = ({ language, handleLanguageChange, t }) => {
  return (
    ...
    <div className="breakdance">
                ...
                <div className="bde-shortcode-130-120 bde-shortcode">
                  ...
                  >
                    ...
                    /><label
                      ...
                      className={`wgcurrent wg-li weglot-lang weglot-language weglot-flags flag-0 ${language === 'fr' ? 'wg-fr' : 'wg-en'}`}
      ...
      <header
        className="bde-header-builder-130-115 bde-header-builder bde-header-builder--sticky bde-header-builder--sticky-scroll-slide bde-header-builder--sticky-bottom bde-header-builder--overlay"
      >
        <div className="bde-header-builder__container">
