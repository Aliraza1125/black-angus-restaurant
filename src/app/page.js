              ...
              <pre className="ti-widget">
                <template id="trustindex-google-widget-html">
                  <div
                    ...
                    data-time-locale="il y a %d %s|aujourd'hui|jour|jours|semaine|semaines|mois|mois|année|ans"
                    data-layout-id="34"
                    data-layout-category="slider"
                    data-set-id="soft"
                    data-pid=""
                    data-language="fr"
                    data-close-locale="Fermer"
                    data-review-target-width="300"
                    data-css-version="2"
                    data-reply-by-locale="Réponse du propriétaire"
                    data-pager-autoplay-timeout="6"
                  >
                    {" "}
                    <div className="ti-widget-container ti-col-3">
                      {" "}
                      <div className="ti-header ti-header-grid source-Google">
                        {" "}
                        <div className="ti-fade-container">
                          {" "}
                          ...
                          <span className="ti-stars star-lg">
                            <trustindex-image
                              className="ti-star"
                              data-imgurl="https://cdn.trustindex.io/assets/platform/Google/star/f.svg"
                              alt="Google"
                              width="17"
                              height="17"
                              loading="lazy"
                            ...
                            <trustindex-image
                              className="ti-star"
                              data-imgurl="https://cdn.trustindex.io/assets/platform/Google/star/h.svg"
                              alt="Google"
                              width="17"
                              height="17"
                              loading="lazy"
                          ...
                          <div className="ti-rating-text">
                            ...
                            <span className="nowrap">
                              Basée sur <strong>8405 avis</strong>
                            </span>{" "}
                          </div>{" "}
                          <div className="ti-large-logo">
                            ...
                            <div className="ti-v-center">
                              ...
                              <trustindex-image
                                ...
                                data-imgurl="https://cdn.trustindex.io/assets/platform/Google/logo.svg"
                                width="150"
                                height="25"
                                loading="lazy"
                                alt="Google"
                      ...
                      <div className="ti-reviews-container">
                        ...
                        <div className="ti-reviews-container-wrapper">
                          ...
                          <div
                            data-empty="0"
                            data-time="1754956800"
                            className="ti-review-item source-Google ti-image-layout-thumbnail"
                            ...
                            <div className="ti-inner">
                              ...
                              <div className="ti-review-header">
                                ...
                                <div className="ti-platform-icon ti-with-tooltip">
                                  ...
                                  <trustindex-image
                                    data-imgurl="https://cdn.trustindex.io/assets/platform/Google/icon.svg"
                                    alt=""
                                    width="20"
                                    height="20"
                                    loading="lazy"
                                ...
                                <div className="ti-profile-img">
                                  {" "}
                                  <trustindex-image
                                    data-imgurl="https://lh3.googleusercontent.com/a/ACg8ocKWtHNtkJsCjIBvOV0EZMB3SijWIQDgExSJIWOiLy1C5pzExA=w40-h40-c-rp-mo-br100"
                                    alt="RUDY CLERC profile picture"
                                    loading="lazy"
                                  ></trustindex-image>{" "}
                                </div>{" "}
                              ...
                              <span className="ti-stars">
                                ...
                                <span className="ti-verified-review ti-verified-platform">
                                  <span className="ti-verified-tooltip">
                                    Trustindex vérifie que la source originale
                                    de l avis est Google.
                                  </span>
                                </span>
                              </span>{" "}
                              <div className="ti-review-text-container ti-review-content">
                                {/* R-CONTENT */}Chlore est la serveuse idéale
                                Je vous met au défi de trouver un
                                professionnalisme pareil.{/* R-CONTENT */}
                              </div>{" "}
                              <span
                            ...
                            <div className="ti-inner">
                              ...
                              <div className="ti-review-header">
                                ...
                                <div className="ti-profile-img">
                                  {" "}
                                  <trustindex-image
                                    data-imgurl="https://lh3.googleusercontent.com/a-/ALV-UjUlQL0-waAmMYSxSyi9qOpVOvgwE4OlsTYezUuG-Wiv34yGTNM=w40-h40-c-rp-mo-br100"
                                    alt="MARTINE ALIBERT profile picture"
                                    loading="lazy"
                                  ></trustindex-image>{" "}
                                </div>{" "}
                                <div className="ti-profile-details">
                              ...
                              <div className="ti-review-text-container ti-review-content">
                                {/* R-CONTENT */}Merci Chloé et Pamela qui nous
                                ont formidablement bien servi, accueil
                                chaleureux et convivial.{/* R-CONTENT */}
                              </div>{" "}
                              <span
                                className="ti-read-more"
                                data-container=".ti-review-content"
                            ...
                            <div className="ti-inner">
                              ...
                              <div className="ti-review-header">
                                ...
                                <div className="ti-profile-img">
                                  {" "}
                                  <trustindex-image
                                    data-imgurl="https://lh3.googleusercontent.com/a/ACg8ocKyfQR52AMd_8HQ03GYrZMVrivh6usKVhm3aLg_ItB3ic9z4A=w40-h40-c-rp-mo-br100"
                                    alt="Eve Canli profile picture"
                                    loading="lazy"
                                  ></trustindex-image>{" "}
                                </div>{" "}
                                <div className="ti-profile-details">
                              ...
                              <div className="ti-review-text-container ti-review-content">
                                {/* R-CONTENT */}Très bon moment partagé dans
                                cette endroit, une bonne ambiance et un accueil
                                au petit soin par Aline qui nous a fait passer
                                un bon moment{/* R-CONTENT */}
                              </div>{" "}
                              <span
                                className="ti-read-more"
                                data-container=".ti-review-content"
                            ...
                            <div className="ti-inner">
                              ...
                              <div className="ti-review-header">
                                ...
                                <div className="ti-profile-img">
                                  {" "}
                                  <trustindex-image
                                    data-imgurl="https://lh3.googleusercontent.com/a/ACg8ocIOwDbDFE1xhyVTWl61FQUsan0cVCBojK0sxFW-RTeChGBpPo23=w40-h40-c-rp-mo-br100"
                                    alt="Louis Sant'anna profile picture"
                                    loading="lazy"
                                  ></trustindex-image>{" "}
                                </div>{" "}
                                <div className="ti-profile-details">
                              ...
                              <div className="ti-review-text-container ti-review-content">
                                {/* R-CONTENT */}Plats délicieux et très bon
                                service de Pamela et Chloé.{/* R-CONTENT */}
                              </div>{" "}
                              <span
                                className="ti-read-more"
                                data-container=".ti-review-content"
                            ...
                            <div className="ti-inner">
                              ...
                              <div className="ti-review-header">
                                ...
                                <div className="ti-profile-img">
                                  {" "}
                                  <trustindex-image
                                    data-imgurl="https://lh3.googleusercontent.com/a-/ALV-UjWtkn3w7OE_JyKaPC0qkhtQ6fNITfkbB3PlVV97IOOOeBvjQno=w40-h40-c-rp-mo-br100"
                                    alt="Charone Jova profile picture"
                                    loading="lazy"
                                  ></trustindex-image>{" "}
                                </div>{" "}
                                <div className="ti-profile-details">
                              ...
                              <div className="ti-review-text-container ti-review-content">
                                {/* R-CONTENT */}Rien à dire très bien, très bon
                                accueil pas{/* R-CONTENT */}
                              </div>{" "}
                              <span
                                className="ti-read-more"
                                data-container=".ti-review-content"
                            ...
                            <div className="ti-inner">
                              ...
                              <div className="ti-review-header">
                                ...
                                <div className="ti-profile-img">
                                  {" "}
                                  <trustindex-image
                                    data-imgurl="https://lh3.googleusercontent.com/a/ACg8ocJWDS87wJxfbUV7RBrwdyfiIv-XckXMpeuFHk-V7TwuL55TWq0=w40-h40-c-rp-mo-br100"
                                    alt="Andie J profile picture"
                                    loading="lazy"
                                  ></trustindex-image>{" "}
                                </div>{" "}
                                <div className="ti-profile-details">
                                  {" "}
                                  <div className="ti-name"> Andie J </div>{" "}
                                  <div className="ti-date"></div>{" "}
                                </div>{" "}
                              </div>{" "}
                              <span className="ti-stars">
                              ...
                              <div className="ti-review-text-container ti-review-content">
                                {/* R-CONTENT */}It was excellent. It s my first
                                time in Paris. My cousin recommended me this
                                restaurant. I loved it. Chloe and Pamela were
                                nice and very efficient{/* R-CONTENT */}
                              </div>{" "}
                              <span
                                className="ti-read-more"
                                data-container=".ti-review-content"
                            ...
                            <div className="ti-inner">
                              ...
                              <div className="ti-review-header">
                                ...
                                <div className="ti-profile-img">
                                  {" "}
                                  <trustindex-image
                                    data-imgurl="https://lh3.googleusercontent.com/a/ACg8ocIPmYsyUmG-rt8d63dmpQl_c9nbvCO7Gnh2UpWrSk5MN6P01g=w40-h40-c-rp-mo-br100"
                                    alt="selaire kofffi profile picture"
                                    loading="lazy"
                                  ></trustindex-image>{" "}
                                </div>{" "}
                                <div className="ti-profile-details">
                              ...
                              <div className="ti-review-text-container ti-review-content">
                                {/* R-CONTENT */}Super service de la part de
                                pamela et Chloé .{/* R-CONTENT */}
                              </div>{" "}
                              <span
                                className="ti-read-more"
                                data-container=".ti-review-content"
                            ...
                            <div className="ti-inner">
                              ...
                              <div className="ti-review-header">
                                ...
                                <div className="ti-profile-img">
                                  {" "}
                                  <trustindex-image
                                    data-imgurl="https://lh3.googleusercontent.com/a/ACg8ocKcSfMRdpEibsYGVvBYGMWNHem2tRNick89W4HQjEYT9pEfKg=w40-h40-c-rp-mo-br100"
                                    alt="Melvin Touré profile picture"
                                    loading="lazy"
                                  ></trustindex-image>{" "}
                                </div>{" "}
                                <div className="ti-profile-details">
                              ...
                              <div className="ti-review-text-container ti-review-content">
                                {/* R-CONTENT */}Merci à Pamela Chloé pour leur
                                conseille et service exceptionnel
                                {/* R-CONTENT */}
                              </div>{" "}
                              <span
                                className="ti-read-more"
                            ...
                            <div className="ti-inner">
                              ...
                              <div className="ti-review-header">
                                ...
                                <div className="ti-profile-img">
                                  {" "}
                                  <trustindex-image
                                    data-imgurl="https://lh3.googleusercontent.com/a/ACg8ocJyjI808u7FQ8U4JdLfRZOGJvNaDTFU6WjCf9Zzk8JH9RUtmQ=w40-h40-c-rp-mo-br100"
                                    alt="Simonneau Julien profile picture"
                                    loading="lazy"
                                  ></trustindex-image>{" "}
                                </div>{" "}
                                <div className="ti-profile-details">
                              ...
                              <div className="ti-review-text-container ti-review-content">
                                {/* R-CONTENT */}Excellent repas, belle
                                découverte. Je recommande vivement aux amateurs
                                de viande rouge. Avec en prime un service
                                irréprochable de Chloé, toujours aux petits
                                soins pour qu’on ne manque de rien.
                                {/* R-CONTENT */}
                              </div>{" "}
                              <span
                                className="ti-read-more"
